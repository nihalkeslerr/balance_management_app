                ...
                <div className="w-full block justify-content-end flex-grow lg:flex lg:items-center lg:w-auto">
                    ...
                    userLoggedIn
                        ...
                        <>
                            ...
                            <Link className='text-sm text-gray-500 no-underline  hover:underline hover:text-blue-800 font-semibold mx-2' to={'/'}>Kuponlar</Link> 
                            ...
                            <Link className='text-sm text-gray-500 no-underline  hover:underline hover:text-blue-800 font-semibold mx-2' to={'/'}>Ödeme Sayfası</Link> 
